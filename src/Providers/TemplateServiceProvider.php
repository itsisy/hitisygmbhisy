...
class TemplateServiceProvider extends ServiceProvider
{
    ...
    public function boot(Twig $twig, Dispatcher $eventDispatcher, ConfigRepository $config)
    {
        ...
        /** @var ContentWidgetRepositoryContract $contentWidgetRepository */
        $contentWidgetRepository = pluginApp(ContentWidgetRepositoryContract::class);
        $contentWidgetRepository->registerWidget(CodeWidget::class);
